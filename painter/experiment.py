...
METHODS = ("static", "residual", "structured", "rich_residual", "region_rich_residual", "refined", "refined_structure", "global_refined", "global_refined_structure", "staged_refined", "staged_refined_structure")
